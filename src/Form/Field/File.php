...
class File extends Field
{
    ...
    protected static $css = [
        '/vendor/laravel-admin/bootstrap-fileinput/css/fileinput.min.css?v=4.3.9',
    ];
     ...
     */
    protected static $js = [
        '/vendor/laravel-admin/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js?v=4.3.9',
        '/vendor/laravel-admin/bootstrap-fileinput/js/fileinput.min.js?v=4.3.9',
    ];
